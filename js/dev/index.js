  ...
  const setTransition2 = (duration2) => {
    ...
    transformElements.forEach((el) => {
      ...
      el.querySelectorAll(".swiper-slide-shadow-top, .swiper-slide-shadow-right, .swiper-slide-shadow-bottom, .swiper-slide-shadow-left").forEach((shadowEl) => {
        shadowEl.style.transitionDuration = `${duration2}ms`;
      });
    });
...
if (document.querySelector("[data-fls-flatpickr]")) {
  const flatPicker = flatpickr("[data-fls-flatpickr]", {
    enableTime: true,
    noCalendar: true,
    dateFormat: "H:i"
  });
  window.flsDatepicker = flatPicker;
}
